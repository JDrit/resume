...
% sets up the margin for A4 paper
\usepackage[a4paper,top=0.5in,left=0.75in,total={6.2in,10.5in}]{geometry}
...
\begin{document}
\name{\Large{Joseph D. Batchik} \hspace{145pt}
  {\small{\href{mailto:josephbatchik@gmail.com}{josephbatchik@gmail.com} - (410) 599-3550}}}
\begin{resume}
