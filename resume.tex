...
\section{Projects}
    ...
    \end{sloppypar} 
    \begin{sloppypar}
        {\bf CSH Hosing Site:} Wrote a python webserver to allow for room registration for future room assignments for members of the Computer Science House.\\
    \end{sloppypar}
    \begin{sloppypar}
        {\bf Wiki Racing:} Wrote a python webserver that would find the shortest path between any two articles on Wikipedia by only clicking on links on the page. \\
    \end{sloppypar}
